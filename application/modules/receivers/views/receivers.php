<div id="headerbar">
    ...
    <h1 class="headerbar-title"><?php _trans('receivers'); ?></h1>
    ...
    <div class="headerbar-item pull-right">
        ...
        <a class="btn btn-primary btn-sm" href="<?php echo site_url('receivers/form'); ?>">
            <i class="fa fa-plus"></i> <?php _trans('new'); ?>
        </a>
    </div>

    <div class="headerbar-item pull-right visible-lg">
        <?php echo pager(site_url('clients/status/' . $this->uri->segment(3)), 'mdl_receiver'); ?>
    </div>
...
<div id="submenu">
    <div class="collapse clearfix" id="ip-submenu-collapse">
        ...
        <div class="submenu-row">
            <?php echo pager(site_url('shipping/orders/'), 'mdl_receiver'); ?>
        </div>
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('receivers/table'); ?>
    </div>
