<div id="headerbar">
    ...
    <h1 class="headerbar-title"><?php _trans('additional_loads'); ?></h1>
    ...
    <div class="headerbar-item pull-right">
        ...
        <a class="btn btn-primary btn-sm" href="<?php echo site_url('additional_loads/form'); ?>">
...
<div id="submenu">
    <div class="collapse clearfix" id="ip-submenu-collapse">
        ...
        <div class="submenu-row">
            <?php echo pager(site_url('additional_loads/index/'), 'mdl_additional_loads'); ?>
        </div>
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('additional_loads/table'); ?>
    </div>
