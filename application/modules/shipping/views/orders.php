<div id="headerbar">
    ...
    <h1 class="headerbar-title"><?php _trans('shipping_order'); ?></h1>
    ...
    <div class="headerbar-item pull-right">
        ...
        <a class="btn btn-primary btn-sm" href="<?php echo site_url('shipping/form'); ?>">
            <i class="fa fa-plus"></i> <?php _trans('new'); ?>
        </a>
    </div>

    <div class="headerbar-item pull-right visible-lg">
        <?php echo pager(site_url('shipping/orders/'), 'mdl_shipping'); ?>
    </div>
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('shipping/table'); ?>
    </div>
