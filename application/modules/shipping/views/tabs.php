  ...
  <div class="col-md-12">
    <div class="panel with-nav-tabs panel-default">
      <div class="panel-heading">
        <ul class="nav nav-tabs">
          ...
          <li class="active"><a href="#shippingOrder" data-toggle="tab">Shipping Order</a></li>
          <li><a href="#trackingDetails" data-toggle="tab">Tracking Details</a></li>
          <li><a href="#moves" data-toggle="tab">Moves</a></li>
          <li><a href="#additional" data-toggle="tab">Additional Loads</a></li>
        <?php //} ?>
          <li style="float: right;"> <?php $this->layout->load_view('layout/header_buttons'); ?></li>
        </ul>
      ...
      <div class="panel-body">
        <div class="tab-content">
         ...
         <div class="tab-pane fade in active" id="shippingOrder">
        ...
        <div class="tab-pane fade" id="trackingDetails">
          ...
          <a href="<?= base_url();?>index.php/tracking_detail/form?shipping_id=<?php echo $this->mdl_shipping->form_value('shippingorderid', true); ?>" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> add</a>
          <br><br>
         <?php 
        $trackingDetails =  getTrackingDetails($shipping_custom->shippingorderid);
    ...
    <table class="table table-striped" >
                ...
                foreach ($trackingDetails as $key => $value) { ?>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('tracking_detail/view/' . $value->trackingdetailid); ?>" target="_blank">
                                    <i class="fa fa-eye fa-margin"></i> <?php _trans('view'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('tracking_detail/form/' . $value->trackingdetailid); ?>" target="_blank">
      ...
      <div class="tab-pane fade" id="moves">
        <a href="<?= base_url();?>index.php/moves/form?shipping_id=<?php echo $this->mdl_shipping->form_value('shippingorderid', true); ?>" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> add</a>
          <br><br>
        <?php 
        $moves =  getMoves($shipping_custom->shippingorderid);
            ...
            <?php if(!empty($moves)){
                foreach ($moves as $key => $value) { ?>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('moves/view/' . $value->movesid); ?>" target="_blank">
                                    <i class="fa fa-eye fa-margin"></i> <?php _trans('view'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('moves/form/' . $value->movesid); ?>" target="_blank">
                                    <i class="fa fa-edit fa-margin"></i> <?php _trans('edit'); ?>
                                </a>
                            </li>
...
<div class="tab-pane fade" id="additional">
        ...
        <a href="<?= base_url();?>index.php/additional_loads/form?shipping_id=<?php echo $this->mdl_shipping->form_value('shippingorderid', true); ?>" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i> add</a>
          <br><br>
        <?php 
        $additional =  getAdditional($shipping_custom->shippingorderid);
            ...
            <?php if(!empty($additional)){
                foreach ($additional as $key => $value) { ?>
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<?php echo site_url('additional_loads/view/' . $value->additional_id); ?>" target="_blank">
                                    <i class="fa fa-eye fa-margin"></i> <?php _trans('view'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('additional_loads/form/' . $value->additional_id); ?>" target="_blank">
                                    <i class="fa fa-edit fa-margin"></i> <?php _trans('edit'); ?>
                                </a>
                            </li>
