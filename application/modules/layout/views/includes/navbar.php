        ...
        <div class="collapse navbar-collapse" id="ip-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-caret-down"></i> &nbsp;
                        <span class="hidden-md"><?php _trans('shipping'); ?></span>
                        <i class="visible-md-inline fa fa-bar-chart"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li><?php echo anchor('shipping/index', trans('shipping_order')); ?></li>
                        <li><?php echo anchor('moves/index', trans('moves')); ?></li>
                        <li><?php echo anchor('tracking_detail/index', trans('tracking_details')); ?></li>
                        <li><?php echo anchor('additional_loads/index', trans('Additional Loads')); ?></li>
                    </ul>
                </li>


                <li>
                    <?php echo anchor('carriers/index', trans('carriers')); ?>
                </li>

                <li>
                    <?php echo anchor('shippers/index', trans('shippers')); ?>
                </li>

                <li>
                    <?php echo anchor('receivers/index', trans('receivers')); ?>
                </li>
