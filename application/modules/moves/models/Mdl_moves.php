 ...
 * Class Mdl_moves
 */
class Mdl_moves extends Response_Model
{
    public $table = 'ip_moves';
    public $primary_key = 'ip_moves.movesid';
    ...
    {
        $this->filter_select('IFnull((SELECT SUM(movesid) FROM ip_moves), 0) AS moves', false);
        return $this;
    }
