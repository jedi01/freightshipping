<div id="headerbar">
    ...
    <h1 class="headerbar-title"><?php _trans('tracking_detail'); ?></h1>
    ...
    <div class="headerbar-item pull-right">
        ...
        <a class="btn btn-primary btn-sm" href="<?php echo site_url('tracking_detail/form'); ?>">
            <i class="fa fa-plus"></i> <?php _trans('new'); ?>
        </a>
    </div>

    <div class="headerbar-item pull-right visible-lg">
        <?php echo pager(site_url('tracking_detail/index/'), 'mdl_tracking_detail'); ?>
    </div>
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('tracking_detail/table'); ?>
    </div>
